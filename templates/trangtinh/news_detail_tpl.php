                ...
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-decoration-none" href="<?= $base_url ?>"><span>Trang chủ</span>
                            </a>
                        </li>
                        <li class="breadcrumb-item active">
                            <a class="text-decoration-none" href="<?= $row_detail['tenkhongdauvi'] ?>"><span><?= $row_detail['ten' . $lang] ?></span>
                            </a>
                        </li>
                    </ol>
                </div>
            </div>
            <!-- <div class="bread_title"><?= $row_detail['ten' . $lang] ?></div> -->
        </div>
    </div>
</div>
