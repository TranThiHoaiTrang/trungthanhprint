...
$nametype = "tac-gia";
$config['news'][$nametype]['title_main'] = "Tác giả";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['check'] = [];
...
$config['news'][$nametype]['title_phu'] = true;
...
$config['news'][$nametype]['social']['facebook'] = true;
$config['news'][$nametype]['social']['youtube'] = false;
$config['news'][$nametype]['social']['pinterest'] = false;
$config['news'][$nametype]['social']['x'] = false;
$config['news'][$nametype]['social']['linkedin'] = true;
$config['news'][$nametype]['social']['zalo'] = true;

/* tin tức */
$nametype = "trang-tinh";
$config['news'][$nametype]['title_main'] = "Trang tĩnh";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
$config['news'][$nametype]['view'] = true;
$config['news'][$nametype]['diachi'] = false;
$config['news'][$nametype]['email'] = false;
$config['news'][$nametype]['dienthoai'] = false;
$config['news'][$nametype]['slug'] = true;
$config['news'][$nametype]['copy'] = true;
$config['news'][$nametype]['bando'] = false;
$config['news'][$nametype]['images'] = true;
$config['news'][$nametype]['images1'] = false;
$config['news'][$nametype]['show_images'] = false;
$config['news'][$nametype]['title_phu'] = true;
$config['news'][$nametype]['motangan'] = true;
$config['news'][$nametype]['motangan_cke'] = true;
$config['news'][$nametype]['mota'] = true;
$config['news'][$nametype]['mota_cke'] = true;
$config['news'][$nametype]['noidung'] = true;
$config['news'][$nametype]['noidung_cke'] = true;
$config['news'][$nametype]['seo'] = true;
$config['news'][$nametype]['width'] = 410;
$config['news'][$nametype]['height'] = 220;
$config['news'][$nametype]['thumb'] = '410x220x1';
$config['news'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
...
$config['news'][$nametype]['view'] = true;
$config['news'][$nametype]['copy'] = true;
$config['news'][$nametype]['solieu'] = false;
...
/* tin tức */
$nametype = "linhvuc-hoatdong";
$config['news'][$nametype]['title_main'] = "Lĩnh vực hoạt động";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
...
/* tin tức */
$nametype = "quatrinh-hinhthanh";
$config['news'][$nametype]['title_main'] = "Quá trình hình thành";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
...
/* tin tức */
$nametype = "doingu-nhanvien";
$config['news'][$nametype]['title_main'] = "Đội ngũ nhân viên";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
...
/* tin tức */
$nametype = "cosohatang";
$config['news'][$nametype]['title_main'] = "Cơ sở hạ tầng";
$config['news'][$nametype]['dropdown'] = true;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
...
/* tin tức */
$nametype = "ly-do";
$config['news'][$nametype]['title_main'] = "Lý do";
...
/* tin tức */
$nametype = "nhung-con-so";
$config['news'][$nametype]['title_main'] = "Những con số";
$config['news'][$nametype]['dropdown'] = false;
$config['news'][$nametype]['list'] = false;
$config['news'][$nametype]['cat'] = false;
$config['news'][$nametype]['check'] = array();
