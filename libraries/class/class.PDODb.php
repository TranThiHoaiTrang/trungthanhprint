...
class PDODb
{
     ...
     * @throws Exception
     */
    public function filter_data( $table, $data ): array
    {
        $filtered_data = [];
    ...
    private function _getTableColumns( $tableName ) {
        ...
        $q = $this->pdo()->query("DESCRIBE $tableName");
     ...
     */
    public function get_all( $tableName, $where = null, $orderby = null, $limit = null ) {

        $add_orderby = '';
        if ( $orderby ) {
            $add_orderby = ' ORDER BY ' . $orderby;
        }
        ...
        $sql = "SELECT * FROM $tableName" . $add_where . $add_orderby . $add_limit;
     ...
     * @return array|false
     */
    public function get_by_id( $tableName, $id, $where = null ) {
        $tableName = '#_' . $tableName;
        ...
        $sql = "SELECT * FROM $tableName WHERE{$add_where} AND id = ? LIMIT 1";
