...
$config = array(
    ...
    */
    ...
    'access_keys' => array('adkey_dmsKHpm5624sf','dmsKHpm5624sf'),//key only apply for admin
    ...
    */
    ...
    //*********************
    'ext_blacklist'							  => ['exe','bat', 'htaccess'], //false
    ...
    *******************/
    ...
    'fixed_path_from_filemanager'             => array( '../thumbs/small/', '../thumbs/large/' ), //fixed path of the image folder from the upload folder
    ...
    'fixed_image_creation_width'              => array( 300, 500 ), //width of image
    'fixed_image_creation_height'             => array( 300, 500 ), //height of image
    /*
    #             $option:     0 / exact = defined size;
    #                          1 / portrait = keep aspect set height;
    #                          2 / landscape = keep aspect set width;
    ...
    */
    ...
    'relative_image_creation_name_to_append'  => array( '_300x300', '_600x600'), //name to append on filename
    'relative_image_creation_width'           => array( 300, 600 ), //width of image
    'relative_image_creation_height'          => array( 300, 600 ), //height of image
    /*
     * $option:     0 / exact = defined size;
     *              1 / portrait = keep aspect set height;
     *              2 / landscape = keep aspect set width;
