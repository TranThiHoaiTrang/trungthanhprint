...
<html>
    <head>
        ...
        <script type="text/javascript" src="//uicdn.toast.com/tui-color-picker/v2.2.0/tui-color-picker.js"></script>
        <script src="//uicdn.toast.com/tui-image-editor/latest/tui-image-editor.js"></script>
                ...
                if(in_array($file_array['extension'], $config['ext_img'])){
                    ...
                    if($ftp){
                        ...
                        if (!file_exists($src_thumb)) {
                            if (!create_img($file_path, $creation_thumb_path, 180, 135, 'crop', $config)) {
                                $src_thumb = $mini_src = "";
                            }
                        }
                        //check if is smaller than thumb
                        list($img_width, $img_height, $img_type, $attr)=@getimagesize($file_path);
                        if($img_width<180 && $img_height<135){
                            $src_thumb=$file_path;
                            $show_original=true;
                        }
