            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">Ngày đăng kí</th>
                    ...
                    <tbody>
                        <?php for($i=0;$i<count($items);$i++) { ?>
                            <tr>
                                ...
                                <!-- <td class="align-middle">
                                    <a class="text-dark" href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['monhoc']?>"><?=$items[$i]['monhoc']?></a>
                                </td> -->
                                <td class="align-middle">
                                    <a class="text-dark" href="<?=$linkEdit?>&id=<?=$items[$i]['id']?>" title="<?=$items[$i]['tieude']?>"><?= date("d/m/Y h:i A", $items[$i]['ngaytao']) ?></a>
                                </td>
