        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="form-group-category row">
                    ...
                    <?php } ?>
                    <?php if(isset($config['newsletter'][$type]['tensanpham']) && $config['newsletter'][$type]['tensanpham'] == true) { ?>
                        <div class="form-group col-md-4">
                            <label for="tensanpham">Tên Sản Phẩm:</label>
                            <input type="text" class="form-control" name="data[tensanpham]" id="tensanpham" placeholder="Tên Sản Phẩm" value="<?=@$item['tensanpham']?>">
                        </div>
                    <?php } ?>
