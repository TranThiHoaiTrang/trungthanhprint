    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul data-accordion="true" class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                if ( $config_menu && !empty( $config_menu['show_menu'] ) ) :

                    $active = '';
                    $menuopen = '';

                    if ( $com == 'menu' || $com == 'menu_location') {
                        $active = 'active';
                        $menuopen = 'menu-open';
                    }

                    $menu_title = $config_menu['title_menu'] ?? 'Menu';
                ?>
                <li class="nav-item has-treeview <?=$menuopen?>">
                    <a class="nav-link <?=$active?>" href="#" title="<?=$menu_title?>">
                        <i class="nav-icon text-sm fa-solid fa-list-tree"></i>
                        <p>
                            <?=$menu_title?>
                            <i class="right fas fa-angle-left"></i>
                        </p>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php $active = ( $com == 'menu' ) ? 'active': ''; ?>
                        <li class="nav-item">
                            <a class="nav-link <?=$active?>" href="<?=ADMIN_URL?>index.php?com=menu&act=list" title="<?=$config_menu['title_menu']?>">
                                <i class="nav-icon text-sm far fa-caret-square-right hide"></i>
                                <p><?=$config_menu['title_menu']?></p>
                            </a>
                        </li>

                        <?php
                        if ( !empty( $config_menu['show_location'] ) ) :
                            $active = ( $com == 'menu_location' ) ? 'active': '';
                        ?>
                        <li class="nav-item">
                            <a class="nav-link <?=$active?>" href="<?=ADMIN_URL?>index.php?com=menu_location&act=list" title="<?=$config_menu['title_location']?>">
                                <i class="nav-icon text-sm far fa-caret-square-right hide"></i>
                                <p><?=$config_menu['title_location']?></p>
                            </a>
                        </li>
                        <?php endif; ?>
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['doday']) && $v['doday'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_doday&type=<?=$k?>" title="Danh mục Bảo hành"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Bảo hành</p></a></li>
                                <?php } ?>
