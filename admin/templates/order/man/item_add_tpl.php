		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body row">
				...
				<div class="form-group col-md-4 col-sm-6">
					...
					<p class="text-info"><?= @$item['httt_text'] ?></p>
							...
							<?php foreach ($chitietdonhang as $k => $v) { ?>
								<tr>
									...
									<td class="align-middle">
										<a title="<?= $v['ten'] ?>"><?= Helper::the_thumbnail($v['photo'], 85, 85, '', $v['ten' . $lang], true) ?></a>
									</td>
									<td class="align-middle">
									...
									<td class="align-middle text-center">
										<div class="price-cart-detail">
											<?php if ($v['giasize']) { ?>
												<span class="price-new-cart-detail"><?= $func->format_money($v['giasize']) ?></span>
									...
									<td class="align-middle text-right">
										<div class="price-cart-detail">
											<?php if ($v['giasize']) { ?>
												<span class="price-new-cart-detail"><?= $func->format_money($v['giasize'] * $v['soluong']) ?></span>
